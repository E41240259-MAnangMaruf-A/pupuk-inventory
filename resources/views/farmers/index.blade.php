                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="land_location" class="form-control" value="{{ $farmer->land_location }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="land_status" class="form-select">
                                                                ...
                                                                <option value="milik" {{ $farmer->land_status == 'milik' ? 'selected' : '' }}>Milik Sendiri</option>
                                                                <option value="sewa" {{ $farmer->land_status == 'sewa' ? 'selected' : '' }}>Sewa</option>
                                                                <option value="garap" {{ $farmer->land_status == 'garap' ? 'selected' : '' }}>Penggarap</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="main_commodity" class="form-control" value="{{ $farmer->main_commodity }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label class="form-label">Rata-rata Panen (Ton)</label>
                                                            <input type="number" step="0.01" name="average_harvest" class="form-control" value="{{ $farmer->average_harvest }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
