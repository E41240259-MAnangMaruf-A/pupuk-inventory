                        ...
                        <div id="SpacingOne" class="accordion-collapse collapse show" aria-labelledby="headingSpacingOne">
                            <div class="accordion-body border-top">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="mb-3">
                                            <label class="form-label">Subsidi <span class="text-danger ms-1">*</span></label>
                                            <select class="select @error('is_subsidized') is-invalid @enderror" name="is_subsidized" required>
                                                <option value="1" {{ old('is_subsidized', 0) == 1 ? 'selected' : '' }}>Disubsidi</option>
                                                <option value="0" {{ old('is_subsidized', 0) == 0 ? 'selected' : '' }}>Tidak Disubsidi</option>
                                            </select>
                                            @error('is_subsidized')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
